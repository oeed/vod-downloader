...
import { CodecResult, SplitStreamResult } from "codec.types";
import * as fs from 'fs';
import { Logger } from "log.helper";
import mv from 'mv';
import * as path from "path";
import { Episode, formatEpisodePath } from "shows.helper";
...
export const saveCodecResult = async (log: Logger, fileID: string, episode: Episode, result: CodecResult) => new Promise(async (resolve, reject) => {
